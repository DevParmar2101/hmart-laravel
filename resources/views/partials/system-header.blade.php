                ...
                <div class="main-menu position-relative">
                    <ul>
                        ...
                        <li class="dropdown "><a href="#">Blog <i class="fa fa-angle-down"></i></a>
                            <ul class="sub-menu">
                                <li class="dropdown position-static"><a href="#">Blog Grid
                                ...
                                <li class="dropdown position-static">
                                    <a href="#">Single Blog <i class="fa fa-angle-right"></i></a>
                                    <ul class="sub-menu sub-menu-2">
                                        <li><a href="#">Single Blog</a>
                                        <li><a href="#">Single Blog Left Sidebar</a>
                                        </li>
                                        <li><a href="#">Single Blog Right Sidebar</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
